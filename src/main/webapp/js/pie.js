...
//                HR: 1
//            },
//            focusableElements: {A: 1, INPUT: 1, TEXTAREA: 1, SELECT: 1, BUTTON: 1},
//            inputButtonTypes: {submit: 1, button: 1, reset: 1},
//            emptyFn: function () {
//            }
//        };
//        try {
...
//            b.ieVersion = c;
//            if (c === 6)b.CSS_PREFIX = b.CSS_PREFIX.replace(/^-/, "");
...
//                    b = 1;
//                    for (a = g.length; b < a; b++)for (f in d = g[b], d)d.hasOwnProperty(f) && (c[f] = d[f]);
//                    return c
...
//                    if (!this._color) {
//                        var b = this.val, a;
//                        if (a = b.match(c.rgbaRE))this._color = "rgb(" + a[1] + "," + a[2] + "," + a[3] + ")", this._alpha = parseFloat(a[4]); else {
...
//                    grad: a.ANGLE
//                },
//                colorFunctions: {rgb: 1, rgba: 1, hsl: 1, hsla: 1},
//                next: function (d) {
//                    function i(b, a) {
...
//            _locked: 0, positionChanged: function () {
...
//                if (this.getCss3()) {
//                    h = new b.Tokenizer(c);
//                    for (k = {}; j = h.next();)if (o = j.tokenType, q = j.tokenValue, !k.imgType && o & l.FUNCTION && q === "linear-gradient") {
//                        w = {stops: [], imgType: q};
//                        for (u = {}; j = h.next();) {
//                            o = j.tokenType;
//                            q = j.tokenValue;
...
//                            } else if (o & l.ANGLE && !w.angle && !u.color && !w.stops.length)w.angle = new b.Angle(j.tokenValue); else if (a(j) && !w.gradientStart && !u.color && !w.stops.length)h.prev(), w.gradientStart = new b.BgPosition(h.until(function (c) {
//                                    return !a(c)
//                                },
//                                !1)); else if (o & m && q === ",")u.color && (w.stops.push(u), u = {}); else break
//                        }
//                    } else if (!k.imgType && o & l.URL)k.imgUrl = q, k.imgType = "image"; else if (a(j) && !k.bgPosition)h.prev(), k.bgPosition = new b.BgPosition(h.until(function (c) {
//                        return !a(c)
//                    }, !1)); else if (o & n)if (q in this.repeatIdents && !k.imgRepeat)k.imgRepeat = q; else if (q in this.originAndClipIdents && !k.bgOrigin)k.bgOrigin = q, (j = h.next()) && j.tokenType & n && j.tokenValue in this.originAndClipIdents ? k.bgClip = j.tokenValue : (k.bgClip = q, h.prev()); else if (q in this.attachIdents && !k.bgAttachment)k.bgAttachment = q; else return null; else if (o & p && !v.color)v.color = b.getColor(q); else if (o & m && q === "/" && !k.bgSize && k.bgPosition)if (j = h.next(), j.tokenType & n && j.tokenValue in this.sizeIdents)k.bgSize = new b.BgSize(j.tokenValue); else if (j = d(j))o = d(h.next()), o || (o = j, h.prev()), k.bgSize = new b.BgSize(j, o); else return null; else if (o & m && q === "," && k.imgType)k.origString = c.substring(r, h.ch - 1), r = h.ch, v.bgImages.push(k), k = {}; else return null;
...
//                        c = i[c.SIZE].split(a);
//                        v.bgImages = [];
//                        for (a = 0; a < k; a++)if ((l = d[a]) && l !== "none")m = c[a].split(" "), v.bgImages.push({
...
//            namedWidths: {thin: "1px", medium: "3px", thick: "5px"},
//            parseCss: function () {
...
//                cssProperty: "border-radius", styleProperty: "borderRadius", parseCss: function (c) {
...
//                            return !c.isLengthOrPercent() && !(c.tokenType & p && c.tokenValue === "auto")
//                        }), r(d.next()) && (m++, l = d.until(function (c) {
//                            return !c.isLength()
//                        }))) : d.prev()
//                    }; c = d.next();)if (i = c.tokenType, h = c.tokenValue, i & (o | q) && !j)d.prev(), w(); else if (s(c) && !a.fill)a.fill = !0, w(); else if (i & p && this.repeatIdents[h] && !a.repeat) {
//                        if (a.repeat = {h: h}, c = d.next())c.tokenType & p && this.repeatIdents[c.tokenValue] ? a.repeat.v = c.tokenValue : d.prev()
//                    } else if (i & n.URL && !a.src)a.src = h; else return null;
//                    if (!a.src || !j || j.length < 1 || j.length > 4 || k && k.length > 4 || m === 1 && k.length < 1 || l &&
//                        l.length > 4 || m === 2 && l.length < 1)return null;
//                    if (!a.repeat)a.repeat = {h: "stretch"};
...
//            cssProperty: "box-shadow", styleProperty: "boxShadow", parseCss: function (c) {
//                var a, d = b.getLength, i = b.Tokenizer.Type, h;
//                if (c) {
//                    h = new b.Tokenizer(c);
//                    a = {outset: [], inset: []};
//                    for (c = function () {
//                        for (var c, k, l, m, n, p; c = h.next();)if (l = c.tokenValue, k = c.tokenType, k & i.OPERATOR && l === ",")break; else if (c.isLength() && !n)h.prev(), n = h.until(function (c) {
//                            return !c.isLength()
//                        }); else if (k & i.COLOR && !m)m = l; else if (k & i.IDENT && l === "inset" && !p)p = !0; else return !1;
//                        c = n && n.length;
//                        if (c > 1 &&
...
//                this.removeLayer(c);
//                for (var b = this._layers || (this._layers = []), d = c + 1, h = b.length, j; d < h; d++)if (j = b[d])break;
//                b[c] = a;
...
//                    a;
//                for (a in c)if (c.hasOwnProperty(a) && c[a].isActive())return !0;
//                return !1
...
//                    if (i === "fixed" && b.ieVersion > 6)j = k.x, k = k.y, d = i; else {
...
//            boxZIndex: 2, boxName: "background",
//            needsUpdate: function () {
...
//                    if (k && j) {
//                        var l = c.fill, m = d.styleInfos, n = m.borderInfo.getProps(), p = n && n.widths, n = p ? p.t.pixels(h) : 0, o = p ? p.r.pixels(h) : 0, q = p ? p.b.pixels(h) : 0, p = p ? p.l.pixels(h) : 0, m = m.backgroundInfo.getProps().bgImages[a], h = m.bgPosition ? m.bgPosition.coords(h, k - i.w - p - o, j - i.h - n - q) : {
//                            x: 0,
//                            y: 0
//                        }, m = m.imgRepeat, q = o = 0, r = k + 1, s = j + 1, w = b.ieVersion === 8 ? 0 : 1, p = Math.round(h.x) + p + 0.5, n = Math.round(h.y) + n + 0.5;
//                        l.position = p / k + "," + n / j;
//                        if (m && m !== "repeat") {
...
//                if (j.isActive())if (b = j.getProps(), j = b.widths, r = b.styles, s = b.colors, b.widthsSame && b.stylesSame && b.colorsSame)s.t.alpha() > 0 && (b = j.t.pixels(a), n = b / 2, k.push({
//                    path: this.getBoxPath({
//                        t: n,
//                        r: n,
//                        b: n,
//                        l: n
//                    }, c), stroke: r.t, color: s.t, weight: b
//                })); else {
//                    c = c || 1;
...
//                return k
//            }, destroy: function () {
//                if (this.finalized || !this.styleInfos.borderImageInfo.isActive())this.targetElement.runtimeStyle.borderColor = "";
//                b.RendererBase.destroy.call(this)
//            }
//        });
//        b.BorderImageRenderer = b.RendererBase.newRenderer({
//            boxZIndex: 5, pieceNames: ["t", "tr", "r", "br", "b", "bl", "l", "tl", "c"], needsUpdate: function () {
...
//                        }
//
//                        var m = d.w, n = d.h, p = b.getLength("0"), o = c.widths || (a ? a.widths : {
//                                t: p,
//                                r: p,
//                                b: p,
//                                l: p
//                            }), p = o.t.pixels(i), q = o.r.pixels(i), r = o.b.pixels(i), o = o.l.pixels(i), s = c.slice, w = s.t.pixels(i), u = s.r.pixels(i), v = s.b.pixels(i), s = s.l.pixels(i);
//                        k("tl", o, p,
//                            0, 0);
//                        k("t", m - o - q, p, o, 0);
//                        k("tr", q, p, m - q, 0);
...
//            boxZIndex: 1, boxName: "outset-box-shadow", needsUpdate: function () {
//                var c = this.styleInfos;
...
//                    if (t)if (H = (m + t) * 2 + p, I = (m + t) * 2 + o, F = t * 2 / H, E = t * 2 / I, t - m > p / 2 || t - m > o / 2)for (m = 4; m--;)r = q[m], J = r.charAt(0) === "b", K = r.charAt(1) === "r", r = c(l, r, v, C, s, t, y), w = r.fill, w.focusposition = (K ? 1 - F : F) + "," + (J ? 1 - E : E), w.focussize = "0,0", r.style.clip = "rect(" + ((J ? I / 2 : 0) + n) + "px," + (K ? H : H / 2) + "px," + (J ? I : I / 2) + "px," + ((K ? H / 2 : 0) + n) + "px)"; else r = c(l, "", v, C, s, t, y), w = r.fill, w.focusposition = F + "," + E, w.focussize = 1 - F * 2 + "," +
//                    (1 - E * 2); else if (r = c(l, "", v, C, s, t, y), v = s.alpha(), v < 1)r.fill.opacity = v
//                }
//            }
//        });
//        b.ImgRenderer = b.RendererBase.newRenderer({
//            boxZIndex: 6, boxName: "imgEl", needsUpdate: function () {
//                var c = this.styleInfos;
...
//                if (!j || b.ieVersion < 7)j = b.getLength("0"), j = {t: j, r: j, b: j, l: j};
//                c.stroked = !1;
//                a.type = "frame";
//                a.src = k;
...
//            bgLayerZIndex: 1, needsUpdate: function () {
...
//            REPEAT: "repeat", STRETCH: "stretch", ROUND: "round", bgLayerZIndex: 0,
//            needsUpdate: function () {
//                return this.styleInfos.borderImageInfo.changed()
//            }, isActive: function () {
//                return this.styleInfos.borderImageInfo.isActive()
...
//                    }
//
//                    var o = i.w, q = i.h, r = h.w, s = h.h, w = c.imageToDataURI(a.src, r, s), u = c.REPEAT, v = c.STRETCH, h = c.ROUND, C = Math.ceil, t = b.getLength("0"), y = a.widths || (d ? d.widths : {
//                                t: t,
//                                r: t,
//                                b: t,
//                                l: t
...
//                            for (var k = g, m = 1; k = k.previousSibling;)if (k.nodeType === 1) {
//                                m = 0;
//                                break
//                            }
//                            m && (g.className += " " + n)
...
//                            (d.y > c.clientHeight || d.x > c.clientWidth || d.y + d.h < 0 || d.x + d.w < 0))R || (R = 1, b.OnScroll.observe(i)); else {
//                            O = 1;
//                            R = N = 0;
...
//                        if (c || A.positionChanged())for (a = 0; a < b; a++)B[a].updatePos();
//                        if (c || A.sizeChanged())for (a = 0; a < b; a++)B[a].updateSize();
//                        x.finishUpdate();
//                        K()
//                    } else N || i()
//                }
...
//                    var c, a = B.length, b;
//                    c = event;
//                    if (!Q && !(c && c.propertyName in p))if (O) {
//                        J();
...
//                k = b.CLASS_PREFIX + "hover", l = b.CLASS_PREFIX + "active", m = b.CLASS_PREFIX + "focus", n = b.CLASS_PREFIX + "first-child", p = {
//                    background: 1,
//                    bgColor: 1,
//                    display: 1
//                }, o = {}, q = [];
